 ...
 */
if ( ! function_exists( 'foundationpress_primary_nav' ) ) {
	function foundationpress_primary_nav() {
		wp_nav_menu( array(
			'container'      => false,
 ...
 * Sidebar Menu
 */
if ( ! function_exists( 'foundationpress_sidebar_nav' ) ) {
	function foundationpress_sidebar_nav() {
		wp_nav_menu( array(
			'container'      => false,                         // Remove nav container
			'menu'           => __( 'sidebar-nav', 'foundationpress' ),
			'menu_class'     => 'vertical menu',
